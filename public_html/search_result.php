  ...
  while ($item = mysqli_fetch_array($item_result)) {
    ...
    echo "
      <li class='list-group-item result-item'>
        <a class='item-name' href='/auction/public_html/'>".$item['name']."</a> <!--TODO-->
        <span class='seller-info'>(sold by <a class='seller-name' href='/auction/public_html'>".$seller['name']."</a>)</span> <!--TODO-->
